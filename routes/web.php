...
Route::middleware('auth')->group(function () {
    Route::prefix('customer')->name('customer.')->group(function () {
        ...
        Route::post('/add-elements', [PelangganController::class, 'elementsAdd'])->name('add-elements');
    });
    Route::prefix('product')->name('product.')->group(function () {
        ...
        Route::post('/add-elements', [ProdukController::class, 'elementsAdd'])->name('add-elements');
    });
    Route::prefix('sales')->name('sales.')->group(function () {
        ...
        Route::post('/add-elements', [PenjualanController::class, 'elementsAdd'])->name('add-elements');
    ...
    Route::prefix('user')->name('user.')->group(function () {
        ...
        Route::post('/add-elements', [UserController::class, 'elementsAdd'])->name('add-elements');
    });
});